...
<form action='./dziennik_validate_form_edit.php' method='post'>
            ...
            if(!empty($id_ucznia) && $id_ucznia!=NULL){
                ...
                <input value='.$imie2.' type='text' id='imie2' name='imie2'>
            ...
            <div class='col-md-12 journal_form journal_form_desc'>
                <textarea id='opis' name='opis' rows='10' style='resize: none' required>".$opis."</textarea>
            </div>
            <p>Podano</p>
            <div class='col-md-12 journal_form journal_form_desc'>
                <textarea id='podano' name='podano' rows='4' style='resize: none'>".$co_podano."</textarea>
            </div>
