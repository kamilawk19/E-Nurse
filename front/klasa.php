...
<nav class="navbar">
    ...
    <div class="container">
        ...
        <header>
            ...
            <div class="col-md-4">
                <h1 class="">Klasy</h1>
                <h3 class="col-md-12">'.$_SESSION['school_id'].'</h3>
            </div>
        </header>
        ';
//        echo "Wybrałeś klasę o id =" . $class_id . " <br>";
        ...
        else
        {
            ...
            echo '<div class="row col-md-10 offset-md-1 background__container classes">
                    <div class="sort_filtr">   
                        <h3>Sortuj</h3>
                        <div class="dropdown">
                            <button class="dropdown-toggle btn-white" type="button" data-toggle="dropdown">A-Z</button>
                    ...
                    <div class="row titles">
                        ...
                        <p class="col-md-3">Nazwisko i Imię</p>
                        <p class="col-md-2 title">Badania</p>                
                    </div>
';
                    ...
                    while($row = $result->fetch_assoc())
                    {
                        ...
                        <div class="students">                
                            <div class="row background__container student">
                                <p class="col-md-1 title">'.$row['Id'].'</p>
                                <p class="col-md-3">'.$row["First_Name"].' '.$row["Last_Name"].'</p>
                                <div class="col-md-3 check-ups">
                                    <p>Kl. "0"</p>
                                    <p>Kl. III</p>
                                    <p>Kl. V</p>
                                    <p>Kl. VII</p>
                                </div>
                                <div class="col-md-5 list-buttons">
                                    <a class="btn-blue--filled list-btn" href="uczen.php?school_id='.$_SESSION['school_id'].'&class_id='.$class_id.'&student_id='.$row['Id_User'].'">Informacje o uczniu</a>
                                    <a class="btn-peach--filled list-btn" href="wybierz_badanie.php?student_id='.$row['Id_User'].'&class_id='.$class_id.'">Dodaj badanie</a>
                                </div>                    
                            </div>
                        ';
                    }
